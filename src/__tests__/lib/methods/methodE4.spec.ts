...
describe("method E4", () => {
  it("confirms 1501836 is valid (variation 1)", () => {
    expect(methodE4("1501836")).toEqual(Result.VALID);
  });
  it("confirms 9290702 is valid (variation 1)", () => {
    expect(methodE4("9290702")).toEqual(Result.VALID);
  });
  it("confirms 539290858 is valid (variation 1)", () => {
    expect(methodE4("539290858")).toEqual(Result.VALID);
  });
  it("confirms 1501824 is valid (variation 2)", () => {
    expect(methodE4("1501824")).toEqual(Result.VALID);
  });
  it("confirms 1501832 is valid (variation 2)", () => {
    expect(methodE4("1501832")).toEqual(Result.VALID);
  });
  it("confirms 9290701 is valid (variation 2)", () => {
    expect(methodE4("9290701")).toEqual(Result.VALID);
  });

  // Check for invalid result
  it("confirms 12345007 is invalid", () => {
    expect(methodE4("12345007")).toEqual(Result.INVALID);
  });
