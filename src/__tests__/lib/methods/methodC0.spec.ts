...
describe("method C0", () => {
  it("confirms 43001500 is valid (variation 1)", () => {
    expect(methodC0("43001500", "13051172")).toEqual(Result.VALID);
  });
  ...
  it("confirms 0734192657 is valid (variation 2)", () => {
    expect(methodC0("0734192657", "00000000")).toEqual(Result.VALID);
  });
  it("confirms 6932875274 is valid (variation 2)", () => {
    expect(methodC0("6932875274", "00000000")).toEqual(Result.VALID);
  });

  // Check for invalid result
  it("confirms 29837521 with BLZ 13051172 is invalid (variation 1)", () => {
    expect(methodC0("29837521", "13051172")).toEqual(Result.INVALID);
  });
  it("confirms 0132572975 is invalid (variation 2)", () => {
    expect(methodC0("0132572975", "00000000")).toEqual(Result.INVALID);
  });
  it("confirms 3038752371 is invalid (variation 2)", () => {
    expect(methodC0("3038752371", "00000000")).toEqual(Result.INVALID);
  });
});
