...
describe("method B1", () => {
  it("confirms 1434253150 is valid (variation 1)", () => {
    expect(methodB1("1434253150")).toEqual("VALID");
  });
  it("confirms 2746315471 is valid (variation 1)", () => {
    expect(methodB1("2746315471")).toEqual("VALID");
  });
  it("confirms 7414398260 is valid (variation 2)", () => {
    expect(methodB1("7414398260")).toEqual("VALID");
  });
  it("confirms 8347251693 is valid (variation 2)", () => {
    expect(methodB1("8347251693")).toEqual("VALID");
  });
  it("confirms 1501824 is valid (variation 3)", () => {
    expect(methodB1("1501824")).toEqual("VALID");
  });
  it("confirms 1501832 is valid (variation 3)", () => {
    expect(methodB1("1501832")).toEqual("VALID");
  });
  it("confirms 539290858 is valid (variation 3)", () => {
    expect(methodB1("539290858")).toEqual("VALID");
  });
  it("confirms 7414398268 is valid (variation 3)", () => {
    expect(methodB1("7414398268")).toEqual("VALID");
  });
  it("confirms 8347251699 is valid (variation 3)", () => {
    expect(methodB1("8347251699")).toEqual("VALID");
  });

  // Check for invalid result
  it("confirms 0123456789 is invalid", () => {
    expect(methodB1("0123456789")).toEqual("INVALID");
  });
  it("confirms 2345678901 is invalid", () => {
    expect(methodB1("2345678901")).toEqual("INVALID");
  });
  it("confirms 5678901234 is invalid", () => {
    expect(methodB1("5678901234")).toEqual("INVALID");
  });
});
