...
describe("method 61", () => {
  it("confirms 2063099200 is valid", () => {
    expect(method61("2063099200")).toEqual(Result.VALID);
  });
  it("confirms 2063099299 is valid", () => {
    expect(method61("2063099299")).toEqual(Result.VALID);
  });
  ...
  it("confirms 2063098200 is invalid", () => {
    expect(method61("2063098200")).toEqual(Result.INVALID);
  });
  it("confirms 2063099288 is invalid", () => {
    expect(method61("2063099288")).toEqual(Result.INVALID);
  });
  it("confirms 0260860481 is invalid", () => {
    expect(method61("0260860481")).toEqual(Result.INVALID);
  });
});
