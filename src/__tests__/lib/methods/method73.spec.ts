...
describe("method 73", () => {
  it("confirms 0003503398 is valid (variation 1)", () => {
    expect(method73("0003503398")).toEqual("VALID");
  });
  it("confirms 0001340967 is valid (variation 1)", () => {
    expect(method73("0001340967")).toEqual("VALID");
  });
  it("confirms 0003503391 is valid (variation 2)", () => {
    expect(method73("0003503391")).toEqual("VALID");
  });
  it("confirms 0003503392 is valid (variation 3)", () => {
    expect(method73("0003503392")).toEqual("VALID");
  });
