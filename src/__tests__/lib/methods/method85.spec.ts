...
describe("method 85", () => {
  it("confirms 0001156071 is valid (variation A)", () => {
    expect(method85("0001156071")).toEqual(Result.VALID);
  });
  ...
  it("confirms 94013341 is valid", () => {
    expect(method85("94013340")).toEqual(Result.VALID);
  });
  it("confirms 0000156071 is valid (variation C)", () => {
    expect(method85("0000156071")).toEqual(Result.VALID);
  });
  it("confirms 3199100002 is valid (exemption)", () => {
    expect(method85("3199100002")).toEqual(Result.VALID);
  });

  // Check for invalid result
  it("confirms 0001156081 is invalid", () => {
    expect(method85("0001156081")).toEqual(Result.INVALID);
  });
  it("confirms 0000256078 is invalid", () => {
    expect(method85("0000256078")).toEqual(Result.INVALID);
  });
  it("confirms 0000157071 is invalid", () => {
    expect(method85("0000157071")).toEqual(Result.INVALID);
  });
  it("confirms 3199200002 is invalid", () => {
    expect(method85("3199200002")).toEqual(Result.INVALID);
  });
});
